...
export function GuidelinesContent() {
  return (
    <div className="space-y-6 text-left text-navy-800">
      <section>
        <h3 className="mb-2 text-lg font-semibold text-navy-700">Research Context</h3>
        <div className="rounded-lg border border-amber-300 bg-amber-50 p-3">
          <p className="text-sm leading-relaxed">
            This annotation is part of an undergraduate thesis research on <strong>Indonesian statute
            law retrieval</strong>. We are building a system that retrieves relevant KUHPerdata articles
            given a legal query. The initial relevance labels were generated by an open-source LLM,
            but we need <strong>human validation</strong> to ensure the ground truth is trustworthy.
          </p>
