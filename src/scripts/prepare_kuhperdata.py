...
def main():
    ...
    parser.add_argument(
        "--download_raw_pdfs",
        action="store_true",
        help="Download raw PDF files from cleaned_downloads/ (off by default)",
    )
    ...
    if args.download_raw_pdfs:
        ...
        print("Skipping raw PDF download (pass --download_raw_pdfs to enable)")
